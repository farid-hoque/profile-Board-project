...
### Make table using ai assistent and use tailwind css,
   ``` ### Features Included: - Responsive &amp; clean design - Hover effects on
           rows - Status badges - Proper spacing and typography - Subtle shadow and
           border - Striped-ready structure (easy to add `odd:bg-gray-50` if desired)
           Would you like a version with **checkboxes**, **action buttons**, **sorting
           indicators**, or **dark mode**?

### server action and server component for use whole data processing
